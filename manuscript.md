...
Beta-thalassemia is a monogenic hemoglobin disorder caused by mutations in the beta-globin gene (*HBB*), resulting in deficient or absent beta-globin chain synthesis and severe transfusion-dependent anemia. Traditional management — chronic blood transfusions and iron chelation — is burdensome, costly, and does not address the underlying genetic defect. Allogeneic hematopoietic stem cell transplantation (HSCT) offers the only pre-2023 curative option but is constrained by donor availability, transplant-related morbidity, and cost. In December 2023, the United States Food and Drug Administration (FDA) and the European Medicines Agency (EMA) concurrently approved exagamglogene autotemcel (exa-cel; Casgevy™), the world's first CRISPR-Cas9-based gene therapy, for transfusion-dependent beta-thalassemia. The mechanism exploits a fundamental insight: by disrupting the erythroid-specific enhancer of *BCL11A* — a transcriptional repressor that silences fetal hemoglobin (*HBF*) production after birth — CRISPR-edited autologous hematopoietic stem cells permanently reactivate the fetal hemoglobin pathway. In the pivotal Phase 3 CLIMB-Thal-111 trial, 93% of treated patients (n = 52) achieved transfusion independence, with effects durable across all follow-up timepoints. This paper reviews the molecular pathophysiology of beta-thalassemia, the mechanistic rationale and execution of the CRISPR-Cas9 approach embodied in exa-cel, the clinical evidence supporting regulatory approval, and the implications for high-burden populations — particularly in South Asia and Bangladesh, where carrier rates reach approximately 7% and systematic therapeutic access remains critically limited.

**Keywords:** beta-thalassemia, CRISPR-Cas9, fetal hemoglobin, BCL11A, gene therapy, exagamglogene autotemcel, Casgevy, hemoglobinopathy, Bangladesh

---

## 1. Introduction

Hemoglobin disorders represent the most prevalent monogenic diseases worldwide. Beta-thalassemia, caused by over 300 described pathogenic variants in the *HBB* gene on chromosome 11p15.5, disrupts the synthesis of the beta-globin subunit of adult hemoglobin (HbA, α₂β₂). The resulting imbalance between alpha- and beta-globin chains precipitates intraerythroid inclusion bodies, ineffective erythropoiesis, peripheral hemolysis, and progressive multi-organ damage [1,2]. In its most severe form — thalassemia major, or Cooley's anemia — patients require packed red blood cell transfusions every two to four weeks to sustain life, accumulating transfusional iron overload that demands concurrent chelation therapy and eventually causes cardiomyopathy, hepatic cirrhosis, and endocrine dysfunction [3].

The global burden is substantial. Approximately 1.5% of the world population carries a beta-thalassemia allele, with the highest frequencies concentrated in the Mediterranean basin, the Middle East, the Indian subcontinent, and Southeast Asia — geographic regions historically endemic for malaria, where the heterozygous carrier state confers partial resistance to *Plasmodium falciparum* through mechanisms that remain incompletely characterized [4]. In Bangladesh, carrier frequency reaches approximately 7%, placing it among the highest-burden nations globally [5]. An estimated 14,000 or more thalassemia major births occur annually in South Asia, the majority in settings where sustained transfusion programs and iron chelation infrastructure are absent or inadequate [6].

Prior to 2023, the only curative intervention was allogeneic hematopoietic stem cell transplantation (HSCT). Though effective when performed with a matched sibling donor in young patients, HSCT is constrained by three barriers: donor availability (fewer than 30% of patients find an HLA-compatible sibling), transplant-related morbidity including graft-versus-host disease (GvHD), and cost that renders it inaccessible in low- and middle-income countries [7]. Lentiviral gene therapy approaches — most notably betibeglogene spartacus (beti-cel; Zynteglo™), which introduces a functional *HBB* transgene — achieved conditional approval in 2022 but carry insertional mutagenesis concerns inherent to semi-random genomic integration [8].

Against this landscape, CRISPR-Cas9 genome editing offered a fundamentally different therapeutic logic: rather than inserting a corrective transgene or repairing the mutated *HBB* gene, it exploits a naturally occurring developmental compensatory mechanism — fetal hemoglobin (HbF) production — that the human genome already encodes but downregulates postnatally. The December 2023 FDA and EMA approval of exagamglogene autotemcel (exa-cel; Casgevy™), developed jointly by Vertex Pharmaceuticals and CRISPR Therapeutics, marks the first regulatory approval of a CRISPR-based medicine in human history and represents a paradigm shift in the treatment of monogenic disease [9].

This paper synthesizes the molecular biology underlying this approach, the mechanism of action of exa-cel, the clinical evidence from the CLIMB-Thal-111 trial, and the implications — and current limitations — for deploying this technology in high-burden populations including Bangladesh.
...
Beta-thalassemia — a disease that has condemned millions to lifelong transfusion dependency and early death — is now curable. The December 2023 approval of exagamglogene autotemcel marks the translation of a molecular biological insight (BCL11A mediates the developmental silencing of fetal hemoglobin) into an approved human medicine that permanently corrects the pathophysiology of the disease without touching the causative mutation. Ninety-three percent of treated patients in the pivotal trial achieved transfusion independence, with effects that persist at the longest follow-up intervals available.

For populations like Bangladesh — where a 7% carrier rate creates a crushing burden of disease against a backdrop of severely limited therapeutic access — this moment demands a dual response. In the near term: accelerate prevention through carrier screening and prenatal diagnosis programs, which are technically achievable and affordable. In the long term: advocate for and contribute to the development of accessible, affordable gene therapy pathways for South Asia, so that the patients already alive with thalassemia major can access the cure that science has now made real.

The mutation in *HBB* has not changed. The body's fetal hemoglobin system has not changed. What has changed is our ability to re-engage it — permanently, safely, and with approval from regulatory agencies on both sides of the Atlantic. The limiting factors are no longer scientific. They are political, economic, and organizational. That is a different problem — and one that is, at least in principle, more tractable than rewriting the human genome.

The science is ready. The world needs to catch up.
